...
<div class="container mx-auto p-8">
    ...
    <div class="text-right mb-6">
        <button onclick="ShowForm('AddCategory','closeModalBtn')"
            class="bg-green-600 text-white px-4 py-2 rounded-md ">Add New
            Category</button>
    </div>
        ...
        <?php foreach ($data['categories'] as $category): ?>
            <div class="bg-white p-4 rounded-md shadow-md flex items-center justify-between">
                ...
                <div class="flex flex-col justify-center space-y-2">
                    ...
                    <form action="<?php echo URLROOT; ?>/CategoryController/DeleteCategory" method="post"
                        id="DeleteCategory">
        ...
        <div class="max-w-md mx-auto p-6 bg-white rounded-2xl shadow-md border w-3/5">
            ...
            <form id="addCategoryForm" method="POST" enctype="multipart/form-data" class=" items-center space-y-4"
                ...
                <div class="flex flex-row space-x-4 mt-4">
                    ...
                    <label for="categorypicture"
                        ...
                        <svg width="35px" height="35px" viewBox="0 0 24 24" fill="none" id="plusIcon"
                            ...
                            <g id="SVGRepo_iconCarrier">
                                <path d="M6 12H18M12 6V18" stroke="#898989" stroke-width="2" stroke-linecap="round"
                ...
                <button type="submit" id="addCategoryBtn"
                    class="w-full rounded-md m-auto text-white bg-green-600 text-sm px-5 py-2.5">Add Category</button>
            </form>
        ...
        <div class="max-w-md mx-auto p-6 bg-white rounded-2xl shadow-md border w-3/5">
            ...
            <form id="EditCategoryForm" method="POST" enctype="multipart/form-data" class="items-center space-y-4"
                ...
                <div class="flex flex-row space-x-4 mt-4">
                    ...
                    <input type="file" id="Inputcategorypicture" name="Inputcategorypicture" accept="image/*"
                        class="hidden" onchange="displayImage('categorypictureedit', 'Inputcategorypicture')" >
                    <input type="hidden" name="categoryId" id="categoryId">
                    <input type="text" id="categoryNameedit" name="categoryName" placeholder="category name"
                        class="p-2 w-full border border-2 border-gray-600 rounded-md "  />
                </div>

                <button type="submit" id="updateCat"
                class="w-full rounded-md m-auto text-white bg-green-600 text-sm px-5 py-2.5">Update Category</button>
            </form>
