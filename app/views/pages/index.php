                ...
                <div class="flex pb-4 items-center justify-between">
                    ...
                    <?php if (isset($_SESSION['user_id']) && $_SESSION['user_id'] == $wiki->author_id): ?>
                        ...
                        <div class="flex space-x-2">
                            <button type="button" class="editWiki" onclick="GetButton('.editWiki','EditWikiForm')">
                            ...
                            <form action="<?php echo URLROOT; ?>/AuthorController/DeleteWiki" method="post"
                                id="DeleteWiki">
        ...
        <form id="addWikiForm" method="POST" enctype="multipart/form-data" class="items-center space-y-4 "
            ...
            <div class="flex flex-col space-y-4 mt-4">
                <div class="mb-4">
                    ...
                    <input type="file" id="image" name="image" accept="image/*" class="p-2 w-full border rounded-md">
                </div>
...
<div id="EditWiki" class="hidden fixed inset-0 bg-gray-800 bg-opacity-75 flex items-center justify-center z-50">
    <div class="md:w-1/2 mx-auto p-6 bg-white rounded-2xl shadow-md border">
        <div class="flex justify-end">
            <button id="closeModalBtnEditWiki" class="text-gray-500 hover:text-gray-300 focus:outline-none">
                <svg class="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                    xmlns="http://www.w3.org/2000/svg">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12">
                    </path>
        ...
        <form id="editWikiForm" method="POST" enctype="multipart/form-data" class="items-center space-y-4 "
            ...
            <button type="submit"
                class="w-full text-white bg-gray-500 rounded-full text-sm px-5 py-2.5">Edit wiki</button>
        </form>
    </div>
</div>
